                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex">
                                                                                <asp:DropDownList ID="ddlDistrict" runat="server" AutoPostBack="true" onchange="validateDropdown(this)" class="form-control" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex">
                                                                                <asp:DropDownList ID="ddlMandal" runat="server" AutoPostBack="true" onchange="validateDropdown(this)" class="form-control" OnSelectedIndexChanged="ddlMandal_SelectedIndexChanged">
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-4">
																		...
																		Extent of Land<br />
                                                                                (in sq.m)</label>
                                                                            <div class="col-lg-6 d-flex">
                                                                                <asp:TextBox ID="txtLandArea" runat="server" class="form-control" onkeypress="return validateNumberAndDot(event)" MaxLength="16" TabIndex="1" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
																		...
																		Area (In Sq.m)</label>
                                                                            <div class="col-lg-6">
                                                                                <asp:TextBox ID="txtBuiltArea" runat="server" class="form-control" onkeypress="return validateNumberAndDot(event)" TabIndex="1" MaxLength="16" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex">
                                                                                <asp:DropDownList ID="ddlSector" runat="server" class="form-control" onchange="validateDropdown(this)" AutoPostBack="true" OnSelectedIndexChanged="ddlSector_SelectedIndexChanged" Enabled="false">
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-4">
																		...
																		Activity</label>
                                                                            <div class="col-lg-6">
                                                                                <asp:DropDownList ID="ddlLine_Activity" runat="server" class="form-control" onchange="validateDropdown(this)" AutoPostBack="true" OnSelectedIndexChanged="ddlLine_Activity_SelectedIndexChanged" Enabled="false">
                                                                                    <asp:ListItem Text="Select" Value="0" />
                                                                                </asp:DropDownList>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-4">
                                                                                <asp:TextBox ID="txtLandValue" runat="server" class="form-control" onkeypress="return validateAmount(event)" MaxLength="16" TabIndex="1" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-4">
                                                                                <asp:TextBox ID="txtBuildingValue" runat="server" class="form-control" onkeypress="return validateAmount(event)" MaxLength="16" TabIndex="1" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-4">
                                                                                <asp:TextBox ID="txtPMCost" runat="server" class="form-control" onkeypress="return validateAmount(event)" MaxLength="16" TabIndex="1" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-12 d-flex mt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-4">
                                                                                <asp:TextBox ID="txtAnnualTurnOver" runat="server" class="form-control" onkeypress="return validateAmount(event)" MaxLength="16" TabIndex="1" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="tab-pane active" id="basictab3">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        Migrant Workers Act, 2020?
                                                                            ...
                                                                            <div class="col-lg-6 d-flex">
                                                                                <asp:RadioButtonList ID="rblRegMigrantWorkers" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblRegMigrantWorkers_SelectedIndexChanged">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex">
                                                                                <asp:RadioButtonList ID="rblRegManfRepairs" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblRegManfRepairs_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblServicesRenewal" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblServicesRenewal_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblBoilers" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblBoilers_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblLicensetoWorkFac" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblLicensetoWorkFac_SelectedIndexChanged" AutoPostBack="true">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblInterstateMigrantWorkmen" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblInterstateMigrantWorkmen_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblContractLabourAct1970" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblContractLabourAct1970_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblWDruglicence" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblWDruglicence_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblRPLicenceWeights" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblRPLicenceWeights_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblMFLicenceWeights" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblMFLicenceWeights_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblLicenceDealers" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblLicenceDealers_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblFireSafety" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblFireSafety_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblExciseLicenseDistillery" onchange="validateRadioButtonList(this)" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblExciseLicenseDistillery_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblConstitutionLicenceRWD" onchange="validateRadioButtonList(this)" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblConstitutionLicenceRWD_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblBrandLabelReg" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblBrandLabelReg_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblPurposeofExamination" onchange="validateRadioButtonList(this)" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rblPurposeofExamination_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        Drugs Specified In Schedule C, C (1) Excluding Those Specified In Part Xb & Schedule X?</label>
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblScheduleX" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rblScheduleX_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        Distribution Of Drugs Other Than That Specified In Schedule C, C(1), X?
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblDrugloanlicmanfnotshedulec" onchange="validateRadioButtonList(this)" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rblDrugloanlicmanfnotshedulec_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        Than That Specified In Schedule C, C(1) Excluding Those Specified In Schedule X?</label>
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblDruglicrepacksale" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rblDruglicrepacksale_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        Distribution Of Large Volume Parenterals/Sera And Vaccines Excluding Those Specified In Schedule X?
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblDruglicmanfsalevaccnotshedulex" onchange="validateRadioButtonList(this)" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rblDruglicmanfsalevaccnotshedulex_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        Trades Callings and Employment Taxation Rules?</label>
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblProftaxcert" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblProftaxcert_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblCFOPCB" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblCFOPCB_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblOccupancyCertificate" onchange="validateRadioButtonList(this)" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblOccupancyCertificate_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblPipelineCertificate" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblPipelineCertificate_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblShpsestbregformA" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblShpsestbregformA_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblBusinesssLic" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblBusinesssLic_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblLiquorLic" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblLiquorLic_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-6 d-flex ">
                                                                                <asp:RadioButtonList ID="rblExciseVerification" runat="server" onchange="validateRadioButtonList(this)" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblExciseVerification_SelectedIndexChanged">
                                                                                    <asp:ListItem Text="Yes" Value="Y" />
                                                                                    <asp:ListItem Text="No" Value="N" />
                                                                                </asp:RadioButtonList>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 d-flex">
                                                                    <div class="col-md-6" id="txtPower" runat="server" visible="false">
																		...
																		requirement in KW<span
                                                                            ...
                                                                            <div class="col-lg-4">
                                                                                <asp:DropDownList ID="ddlPowerReq" runat="server" onchange="validateDropdown(this)" class="form-control" TabIndex="1">
                                                                                    <asp:ListItem Text="--Select--" Value="0" />
                                                                                </asp:DropDownList>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label class="col-lg-6 col-form-label">
                                                                                    Grant/Renewal Of License To Manufacture<span
                                                                                        class="text-danger">*</span></label>
                                                                                <div class="col-lg-4">
                                                                                    <asp:DropDownList ID="ddlManufacture" runat="server" onchange="validateDropdown(this)" class="form-control">
                                                                                        <asp:ListItem Text="--Select--" Value="0" />
                                                                                    </asp:DropDownList>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="col-md-6" id="divPowerConn" runat="server" visible="false">
                                                                    <div class="form-group row">
