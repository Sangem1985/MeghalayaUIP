                                                                ...
                                                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                                                    ...
                                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
																		...
																		Category of Enterprise<span class="star">*</span></label>
                                                                            <div class="col-lg-6">
                                                                                <asp:Label ID="lblPCBCategory" Font-Bold="true" runat="server" class="form-control" TabIndex="1" Enabled="false"></asp:Label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group row">
                                                                            <label class="col-lg-6 col-form-label">
                                                                                1. Proposed Employment <span class="star">*</span></label>
                                                                            <div class="col-lg-4">
