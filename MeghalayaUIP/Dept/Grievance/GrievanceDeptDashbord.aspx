                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-2 col-sm-6 mb-xl-0 mb-4">
                                <div class="card">
                                    <a href="GrievanceDeptdashboarddrill.aspx?status=TOTALAPPROVALISSUED" style="text-decoration: none;">
                                        <div class="card-header p-3 pt-2">
                                            ...
                                            <div class="text-end pt-1">
                                                <h4 class="mb-0">
                                                   <asp:Label ID="lbltotal" runat="server" Text="100"></asp:Label></h4>
                                ...
                                <div class="card">
                                    <a href="CFEApplDeptView.aspx?status=APPROVALPENDING" style="text-decoration: none;">
                                        <div class="card-header p-3 pt-2">
                                            ...
                                            <div class="text-end pt-1">
                                                <h4 class="mb-0">
                                                    <asp:Label ID="lblpending" runat="server" Text="50"></asp:Label></h4>
                                                <p class="text-sm mb-0 text-capitalize">&nbsp;</p>
                                            </div>
                                        </div>
                                        <hr class="dark horizontal my-0">
                                ...
                                <div class="card">
                                    <a href="CFEApplDeptView.aspx?status=TOTALAPPROVALISSUED" style="text-decoration: none;">
                                        <div class="card-header p-3 pt-2">
                                            ...
                                            <div class="text-end pt-1">
                                                <h4 class="mb-0">
                                                    <asp:Label ID="lblredressed" runat="server" Text="30"></asp:Label></h4>
                                                <p class="text-sm mb-0 text-capitalize">&nbsp;</p>
                                            </div>
                                        </div>
                                        <hr class="dark horizontal my-0">
                                ...
                                <div class="card">
                                    <a href="CFEApplDeptView.aspx?status=REJECTED" style="text-decoration: none;">
                                        <div class="card-header p-3 pt-2">
                                            ...
                                            <div class="text-end pt-1">
                                                <h4 class="mb-0">
                                                    <asp:Label ID="lblrejected" runat="server" Text="20"></asp:Label></h4>
                                                <p class="text-sm mb-0 text-capitalize">&nbsp;</p>
                                            </div>
                                        </div>
                                        <hr class="dark horizontal my-0">
