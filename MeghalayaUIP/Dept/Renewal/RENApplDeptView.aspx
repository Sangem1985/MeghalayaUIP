    ...
    <div class="page-wrapper" style="">
        <div class="content container-fluid">
            ...
            <div class="card-header d-flex justify-content-between">
                <h4 class="card-title mt-1"><b>View Renewal Applications</b></h4>
                <div class="col-md-1">
                ...
                <div class="card-body">
                    ...
                    <asp:GridView ID="gvCFEDtls" runat="server" AutoGenerateColumns="False" BorderColor="#003399" ShowHeaderWhenEmpty="true"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Dept ID" DataField="RENDA_DEPTID" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-ForeColor="WindowText" Visible="false" />
                            <asp:BoundField HeaderText="Approval ID" DataField="RENDA_APPROVALID" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-ForeColor="WindowText" Visible="false" />
                            <asp:BoundField HeaderText="Unit ID" DataField="RENID_UNITID" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-ForeColor="WindowText" Visible="false" />
                            ...
                            <asp:TemplateField HeaderText="Actions" ItemStyle-Width="12%">
                                ...
                                <ItemTemplate>
                                    <asp:Button ID="ciw_id" runat="server" Text='Process' CommandName="VIEW" CssClass="btn btn-info"
                                        CommandArgument='<%# Eval("RENID_RENQDID")+"$"+Eval("INVESTERID")+"$"+Eval("RENID_UNITID")+"$"+Eval("RENDA_APPROVALID")+"$"+Eval("RENDA_DEPTID")%>' />
                                </ItemTemplate>
