<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="SRVCBusinessLicenseDetails.aspx.cs" Inherits="MeghalayaUIP.User.Services.SRVCBusinessLicenseDetails" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 d-flex" id="stall" runat="server" visible="false">
                                            <div class="col-md-4">
                                              ...
                                              <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-lg-6 col-form-label">Ward No. of Establishment *</label>
                                                    <div class="col-lg-6 d-flex">
