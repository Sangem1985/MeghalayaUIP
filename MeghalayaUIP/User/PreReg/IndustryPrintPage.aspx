                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                                ...
                                <div class="col-md-6 d-flex">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label ID="lbldistic" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                                ...
                                <div class="col-md-6 d-flex">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label ID="lbProductManf" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                                ...
                                <div class="col-md-6 d-flex">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label ID="lblProvided" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                                ...
                                <div class="col-md-6 d-flex">
                                    <div class="col-md-6">Details of Waste / Effluent to be generated:</div>
                                    <div class="col-md-6">
                                        <asp:Label ID="lblHazardous" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                            ...
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                                ...
                                <div class="col-md-6 d-flex">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label ID="lblMeasurement" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                            ...
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                                <div class="col-md-6 d-flex">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label ID="lblPlantMach" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <div class="col-md-6 d-flex">
                            ...
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                                ...
                                <div class="col-md-6 d-flex">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label ID="lblValueLand" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                                ...
                                <div class="col-md-6 d-flex">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label ID="lblvaluewater" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 d-flex tablepadding">
                                ...
                                <div class="col-md-6 d-flex">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label ID="lblCapitalsub" runat="server"></asp:Label>
                                    </div>
                                </div>
