                                                    ...
                                                    <div class="table-responsive" runat="server">
                                                        <asp:GridView ID="gvDPRChecklist" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Name" ItemStyle-Width="65%">
                                                                    <ItemStyle />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblName" runat="server" Text='<%#Eval("DOC_NAME") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Verified" ItemStyle-Width="30%">
                                                                    <ItemStyle />
                                                                    <ItemTemplate>
                                                ...
                                                <div class="col-md-12 d-flex" runat="server">
                                                    <div class="col-md-12">
                                                        <div class="form-group row mt-2">
                                                            ...
                                                            <div class="col-lg-1 d-flex mt-2">
                                                                :
                                                            </div>
                                                            <div class="col-lg-2 d-flex mt-2">
                                                                <asp:TextBox ID="txtRemark" runat="server" TextMode="MultiLine" class="form-control" MaxLength="50"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
