                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item" runat="server" id="Li1"><a class="nav-link  active" href="#basictab1" data-toggle="tab">1.
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    <label
                                                                        ...
                                                                        Gunthas</label>
                                                                    <div class="col-lg-6">
                                                                        <asp:TextBox ID="txtGunthas" runat="server" class="form-control"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12 d-flex">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <asp:TextBox ID="txtPolCategory" runat="server" class="form-control"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    <label class="col-lg-6 col-form-label">
																		...
																		Enterprise</label>
                                                                    <div class="col-lg-6">
                                                                        <asp:TextBox ID="txtEnterpriseType" runat="server" class="form-control"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                    ...
                                                    <%--<form action="#">--%>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 d-flex mt-2">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <asp:Button ID="btnsave2" runat="server" Text="Save" class="btn btn-rounded btn-info btn-lg" padding-right="10px" BackColor="Green" OnClick="btnsave2_Click" />
                                                                    <%--  <a href="#basictab1" data-toggle="tab">
                                                                        <button type="submit"
                                                                            class="btn btn-rounded btn-success btn-lg">
                                                                            Previous</button></a>--%>
