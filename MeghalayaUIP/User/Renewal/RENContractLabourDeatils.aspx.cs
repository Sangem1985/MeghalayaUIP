    ...
    public partial class RENContractLabourDeatils : System.Web.UI.Page
    {
        ...
        protected void GetAppliedorNot()
        {
            try
            {
                ...
                ds = objRenbal.GetRenAppliedApprovalID(hdnUserID.Value, Convert.ToString(Session["RENQID"]), "10", "73");
        ...
        public void Binddata()
        {
            ...
            {
                DataSet ds = new DataSet();
                ds = objRenbal.GetRenContractDetails(hdnUserID.Value, Questionnaire);
