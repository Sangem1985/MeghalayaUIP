                                ...
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdApprovals" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            CssClass="table-bordered table-responsive mb-0 GRD table-hover" ForeColor="#333333" Width="100%" ShowFooter="true" OnRowDataBound="grdApprovals_RowDataBound">
                    ...
                    <div class="col-md-12  col-lg-12 col-sm-12 col-xs-12 d-flex">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br />
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex d-flex" runat="server" visible="false" id="div2">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=1--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex d-flex" runat="server" visible="false" id="divPCB">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex d-flex">
                                            ...
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex d-flex">
                                ...
                                <%-- Approvalid=2--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex d-flex" runat="server" visible="false" id="divHazPCB">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 d-flex col-form-label">Authorization under the Hazardous and Other Waste (Management and Transboundary Movement) Rules 2016 </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex d-flex">
                                ...
                                <%-- Approvalid=3--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex d-flex" runat="server" visible="false" id="divSrvcCon">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 d-flex col-form-label">Service Connection Certificate </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex d-flex">
                                ...
                                <%-- Approvalid=4--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex d-flex" runat="server" visible="false" id="divEleCon">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 d-flex col-form-label">Obtaining Electricity Connection </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex d-flex">
                                ...
                                <%-- Approvalid=5--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex d-flex" runat="server" visible="false" id="divFctryPlan">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 d-flex col-form-label">Factory Plan Approval  </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex d-flex">
                                ...
                                <%-- Approvalid=6--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex d-flex" runat="server" visible="false" id="divDGsetNOC">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 d-flex col-form-label">NOC DG Set </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex d-flex">
                                ...
                                <%-- Approvalid=7--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex d-flex" runat="server" visible="false" id="divFireSfty">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 d-flex col-form-label">Provisional Fire Safety Certificate </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex d-flex">
                                ...
                                <%-- Approvalid=8--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex d-flex" runat="server" visible="false" id="divRSDSLic">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 d-flex col-form-label">Licence to store RS, DS </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex d-flex">
                                ...
                                <%-- Approvalid=9--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divExplsvNOC">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">NOC required for setting up of Explosives Manufacturing, Storage, Sale, Transport </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=10--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divPtrlNOC">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">NOC Required for Setting Up of Petroleum, Diesel & Naphtha Manufacturing, Storage, Sale, Transport</label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=11--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divRdCtng">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Road Cutting Permission Letter </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=12--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divNonEncmb">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Non Encumbrance Certificate</label>
                                            <div class="col-lg-1 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=13--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divProfTax">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Certificate of Registration of Professional Tax under the Meghalaya Professions Trades Callings and Employment Taxation Rules </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=14--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divElcInsp">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Electrical Drawing Approval from Electrical Inspectorate </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=15--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divForstDist">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Letter for distance from Forest </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=16--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divNonForstLand">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Non-Forest Land Certificate </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=17--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divIrrgNOC">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">FTL NOC for Change of Land use (Irrigation) </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=18--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divRevNOC">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">FTL NOC for Change of Land use (Revenue) </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=19--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divGrndWtrNOC">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">NoC for Ground Water Abstraction for Commercial Connection </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=20--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divNoWtrSplyCertfct">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Certificate for non-availability of water supply from water supply agency</label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=21--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divPrmsntoDrawWtr">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Permission to Draw Water from River/Public Tanks</label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=22--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divMunicipalWatr">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Water Connection for the Municipal Area </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=23--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divUrbanWatr">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Grant of Water Connection to Non Municipal urban areas </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=25--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divLbrAct1970">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Registration of Establishments/Principal Employer Employing Contract Labour Act 1970</label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=26--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divLbrAct1979">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Registration of establishment under the Interstate Migrant Workmen Act 1979 </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=27--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divLbrAct1996">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Registration of Establishments employing Building Workers under the Building and Other Construction Work Act 1996 </label>
                                            <div class="col-lg-1 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=28--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divContrLbrAct">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">License under Contract Labour Act (Contractor) </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                ...
                                <%-- Approvalid=29--%>
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divContrLbrAct1979">
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Registration under Inter State Migrant Workman Act 1979 (For Contractor) </label>
                                            <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                :
                                            </div>
                                            <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                            ...
                                            <div class="col-lg-1 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                    ...
                                    <%-- Approvalid=30--%>
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divConstrPermit">
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Construction Permit Approval </label>
                                                <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                    :
                                                </div>
                                                <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
                                    ...
                                    <%-- Approvalid=31--%>
                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 d-flex" runat="server" visible="false" id="divBldngPlan">
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-lg-4 col-sm-12 col-xs-12 col-form-label">Industrial Building Plan Approval </label>
                                                <div class="col-lg-1 col-lg-1 col-sm-12 col-xs-12 d-flex">
                                                    :
                                                </div>
                                                <div class="col-lg-2 col-lg-2 col-sm-12 col-xs-12 d-flex">
