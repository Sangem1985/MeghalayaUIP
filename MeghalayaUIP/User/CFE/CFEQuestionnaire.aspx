                                                ...
                                                <div class="col-md-12 d-flex">
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <asp:TextBox ID="txtPolCategory" Font-Bold="true" runat="server" class="form-control"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-form-label">
                                                                9. Type of
																		Industry</label>
                                                            <div class="col-lg-6">
                                                                <asp:DropDownList ID="ddlIndustryType" runat="server" RepeatDirection="Vertical">
                                                ...
                                                <div class="col-md-12 d-flex mt-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <h4>
                                                                    <asp:Label ID="lblEntCategory" runat="server"></asp:Label></h4>
                                                            </div>
                                                        </div>
                                                    </div>
