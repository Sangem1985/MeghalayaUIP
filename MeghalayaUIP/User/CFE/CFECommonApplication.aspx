                        ...
                        <div class="col-md-3">
                            <div class="form-group row">
                                <div class="col-lg-6 d-flex">
                                    <asp:Button ID="btnSubmit" runat="server" class="btn btn-rounded btn-info btn-lg" BackColor="Green" Text="Submit" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group row">
                                <div class="col-lg-6 d-flex">
                                    <asp:Button ID="btnClear" runat="server" class="btn btn-rounded btn-info btn-lg" BackColor="Orange" Text="Clear" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3"></div>
