<%@ Page Title="" Language="C#" MasterPageFile="~/Dept/dept.Master" AutoEventWireup="true" CodeBehind="LandDistWiseReportDrillDown.aspx.cs" Inherits="MeghalayaUIP.Dept.Reports.LandDistWiseReportDrillDown" %>
    ...
    <div class="page-wrapper griddesignmulticount">
        <div class="content container-fluid">
            ...
            <div class="card-header d-flex justify-content-between">
                <h4 class="card-title mt-1"><b>Land District Wise Report: </b></h4>
            ...
            <section id="dashboardcount" class="mt-2">
                <div class="container-fluid">
                    <div class="table-responsive">
                        <asp:GridView ID="GVLADistWise" runat="server" AutoGenerateColumns="False" BorderColor="#003399" ShowHeaderWhenEmpty="true"
