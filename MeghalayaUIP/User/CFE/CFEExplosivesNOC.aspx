                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">EXPLOSIVE Details</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-md-12 d-flex">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 d-flex">
                                                <asp:TextBox ID="txtDivision" runat="server" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                   <div class="col-md-12 d-flex">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 d-flex">
                                                <asp:TextBox ID="txtQuantityTime" runat="server" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 d-flex">
                                                <asp:TextBox ID="txtQuantityMonth" runat="server" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                                ...
                                <div class="col-md-12 d-flex">
                                    <div class="col-md-11">
                                        <div class="form-group row">
                                            <label class="col-lg-8 col-form-label">Details of site where explosives will be used and distance of site of use from the storage premises (in case of licence for use)  *</label>
                                  ...
                                  <div class="col-md-12 d-flex">
                                        <div class="col-md-11">
                                        <div class="form-group row">
                                            <label class="col-lg-8 col-form-label">Details of explosives road van which will be used for transportation of explosives (in case of no objection certificate for road van)</label>
                                            <div class="col-lg-2 d-flex">
                                                <asp:TextBox ID="txtRoadVan" runat="server" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>   
                                      </div>
                                 ...
                                 <div class="col-md-12 d-flex">
                                       <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-lg-6 col-form-label">(i) I or We have not been convicted under any offence or ordered to execute bond under Chapter VIII of Code of Criminal Procedure, 1973, during the last 10 years ( If yes, please give details).*</label>
                                            <div class="col-lg-4">
                                       ...
                                       <div class="col-md-4" id="Details" runat="server" visible="false">
                                        <div class="form-group row">
                                  ...
                                  <div class="col-md-12 d-flex">
                                       <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-lg-6 col-form-label">(ii) Particulars of other licenses: I / We possess under Explosives Act, 1884 (Note: Please write the licence no(s), if any) *</label>
                                            <div class="col-lg-4">
                                       ...
                                       <div class="col-md-4" id="LicDetails" runat="server" visible="false">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Details  *</label>
                                            <div class="col-lg-6 d-flex">
                                                <asp:TextBox ID="txtDet" runat="server" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                      </div>
                                  <div class="col-md-12 d-flex">
                                       <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-lg-6 col-form-label">(iii) I/We have obtained approval as required under rule 101 from the competent authority: (Note: Please enclose the approval letter, approved drawing(s), other enclosures, if any) *</label>
                                            <div class="col-lg-4">
                                       ...
                                       <div class="col-md-4" id="approvaldet" runat="server" visible="false">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Details  *</label>
                                            <div class="col-lg-6 d-flex">
                                                <asp:TextBox ID="txtDetail" runat="server" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                      </div>
                                 <div class="col-md-12 d-flex">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 d-flex">
                                                <asp:TextBox ID="txtinformation" runat="server" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                     </div>
