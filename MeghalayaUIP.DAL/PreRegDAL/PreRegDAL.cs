    ...
    public class PreRegDAL
    {
        ...
        public DataSet GetUserCommentsofAmmendmentsid(int ammendentid)
        {
           DataSet ds = new DataSet();
            ...
            try
            {
                ...
                SqlDataAdapter da;
                da = new SqlDataAdapter(PreRegConstants.GetUserAmmendments, connection);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.CommandText = PreRegConstants.GetUserAmmendments;
        ...
        public string InsertDeptAmmendments(AmmendmentVo ammendment, List<Deptcomments> lstformvo)
        {
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand();
                com.CommandType = CommandType.StoredProcedure;
                com.CommandText = PreRegConstants.InsertDeptAmmendments;
