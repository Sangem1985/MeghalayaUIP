<%@ Page Title="" Language="C#" MasterPageFile="~/Dept/dept.Master" AutoEventWireup="true" CodeBehind="CFODeptWiseReportDrillDown.aspx.cs" Inherits="MeghalayaUIP.Dept.Reports.CFODeptWiseReportDrillDown" %>
    ...
    <div class="page-wrapper griddesignmulticount">
        <div class="content container-fluid">
            ...
            <div class="card-header d-flex justify-content-between">
                <h4 class="card-title mt-1"><b>CFO Department Wise Report: </b></h4>
