<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="RENDrugLicDetails1.aspx.cs" Inherits="MeghalayaUIP.User.Renewal.RENDrugLicDetails1" %>
                                        ...
                                        <div class="drug" id="drug">
                                            ...
                                            <div class="col-md-12 d-flex">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <div class="col-lg-6 d-flex">
                                                            <asp:Button ID="btn" runat="server" Text="Add" OnClick="btn_Click" CssClass="btn btn-green btn-rounded" Width="110px" />
                                                        </div>
                                                    </div>
                                                </div>


                                                <div class="col-md-4 d-flex justify-content-center ml-3">
                                                    <asp:GridView ID="GVDrugName" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                        BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CssClass="GRD table table-bordered table-striped" ForeColor="#333333"
                                                        GridLines="None" EnableModelValidation="True" Visible="false" OnRowDeleting="GVDrugName_RowDeleting">
                                                        <RowStyle BackColor="#ffffff" BorderWidth="1px" />
                                                        <Columns>
                                                            <%--<asp:CommandField HeaderText="Delete" ShowDeleteButton="True" ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" ControlStyle-ForeColor="Black" />
                                                            <asp:BoundField HeaderText="Name of Drug " DataField="REND_DRUGNAME" ItemStyle-Width="230px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" />--%>

                                                             <asp:CommandField HeaderText="Delete" ShowDeleteButton="True"
                                                                ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" />
                                                            <asp:BoundField HeaderText="Name of Drug" DataField="REND_DRUGNAME"
                                                                ItemStyle-Width="200px" HeaderStyle-HorizontalAlign="Center"
                                                                ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="Wheat"
                                                                ItemStyle-ForeColor="WindowText" />
                                            ...
                                            <div class="col-md-12 d-flex justify-content-center">
                                                <div style="min-width: 600px;">
                                                    <asp:GridView ID="GVTEST" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                        BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CssClass="GRD table table-bordered table-striped"
                                                        ForeColor="#333333" GridLines="None" OnRowDeleting="GVTEST_RowDeleting"
                                                        EnableModelValidation="True" Visible="false">
                                                        <RowStyle BackColor="#ffffff" BorderWidth="1px" />
                                                        <Columns>
                                                            <asp:CommandField HeaderText="Delete" ShowDeleteButton="True"
                                                                ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" />
                                                            <asp:BoundField HeaderText="Name" DataField="RENST_NAME"
                                                                ItemStyle-Width="200px" HeaderStyle-HorizontalAlign="Center"
                                                                ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="Wheat"
                                                                ItemStyle-ForeColor="WindowText" />
                                                            <asp:BoundField HeaderText="Qualification" DataField="RENST_QUALIFICATION"
                                                                ItemStyle-Width="200px" HeaderStyle-HorizontalAlign="Center"
                                                                ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="Wheat"
                                                                ItemStyle-ForeColor="WindowText" />
                                                            <asp:BoundField HeaderText="Experience" DataField="RENST_EXPERIENCE"
                                                                ItemStyle-Width="200px" HeaderStyle-HorizontalAlign="Center"
                                                                ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="Wheat"
                                                                ItemStyle-ForeColor="WindowText" />
                                                        </Columns>
