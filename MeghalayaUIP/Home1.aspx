...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p class="blink">Come, Invest in Meghalaya</p>
                    ...
                    <div class="slide-inner slide-bg-image" data-background="assets/images/slider/slide-3.jpg">
                        <div class="container">
                            <div data-swiper-parallax="400" class="slide-text">
                                <p>Invest Meghalaya Authority Welcomes you</p>
                            </div>
                            <div data-swiper-parallax="300" class="slide-title">
                                <h2>Onto the Single Window Portal.</h2>
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="slide-inner slide-bg-image" data-background="assets/images/slider/slide-2.jpg">
                        <div class="container">
                            ...
                            <div data-swiper-parallax="300" class="slide-title">
                                <h2>Largest producer of coal and limestone in North-East India.</h2>
                            </div>
                ...
                <div class="col col-md-6">
                    ...
                    <div class="details">
                        ...
                        <p style="margin-bottom: 5px;">
                            As part of this, we have roll out Meghalaya Industrial and
                                Investment Promotion Policy, IT & ITES Promotion Policy, Meghalaya Power Policy, etc to
                                further the growth of our State.
                        </p>
                        <p style="margin-bottom: 5px;">
                            The picturesque state receives the highest rainfall in the
                        ...
                        <p>
                            Meghalaya as an investment destination, we have curated different policies and
                                interventions for ease of doing business.
                        </p>
                ...
                <div class="col col-md-6">
                    <div class="right-col">
                        <div class="img-holder">
                            <img src="assets/images/about.png" alt="" style="box-shadow: 0 10px 20px rgba(0, 0, 0, 0.2);">
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="icon-box" title="Employer" id="one">
                        <div class="box">
                            <div class="icon">
                                <img src="assets/images/param/icon1.png">
                            </div>
                            <h4>6%<br />
                            </h4>
                            <p style="color: #000;">
                                CAGR of GSDP between
                    2025-16 and 2020-21
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-2">
                    <div class="icon-box" title="Employer" id="one">
                        <div class="box">
                            <div class="icon">
                                <img src="assets/images/param/icon2.png">
                            </div>
                            <h4>$10.14 Mn<br />
                            </h4>
                ...
                <div class="col-lg-2">
                    <div class="icon-box" title="Employer" id="one">
                        <div class="box">
                            <div class="icon">
                                <img src="assets/images/param/icon3.png">
                            </div>
                            <h4>76%<br />
                            </h4>
                ...
                <div class="col-lg-2">
                    <div class="icon-box" title="Employer" id="one">
                        <div class="box">
                            <div class="icon">
                                <img src="assets/images/param/icon4.png">
                            </div>
                            <h4>$5 Bn<br />
                            </h4>
                            <p style="color: #000;">
                ...
                <div class="col-lg-2">
                    <div class="icon-box" title="Employer" id="one">
                        <div class="box">
                            <div class="icon">
                                <img src="assets/images/param/icon5.png">
                            </div>
                            <h4>3K MW<br />
                            </h4>
            ...
            <div class="row">
                <div class="col col-md-6 first">
                    <div class="section-title-s2" style="margin: 0px; display: flex; justify-content: center;">
                        ...
                        <h2
                            style="color: #131e4a !important; font-family: 'Montserrat', sans-serif; font-weight: 500; text-align: center; margin-top: 34px; margin-left: 12px; font-size: 32px;">Single Window of Clearance</h2>
                    </div>
                    <div class="boxshadaufirst goinvestor">
                        <div class="col-md-12" style="padding: 4px 0px; background: #673ab714; border-radius: 8px;">
                            <div class="col col-md-3" style="text-align: center !important;">
                                <ul class="golist">
                                    <li>
                                        <a href="#" target="_blank" class="img14">
                                            <img class="" src="assets/images/circle/circle-1.png" style="left: 0px !important;"></a>
                                    </li>
                                </ul>

                            </div>
                            <div class="col col-md-9">
                                <h5 class="mt-3">Online validation and processing of License permit applications & customs declarartions.</h5>
                            </div>
                        </div>
                        <div class="col-md-12" style="padding: 4px 0px;">

                            <div class="col col-md-9">
                                <h5 class="mt-3">Electronic workflow for processing permit applications, release, and clearance.</h5>
                            </div>
                            <div class="col col-md-3">
                                <ul class="golist">
                                    <li>
                                        <a href="#" target="_blank" class="img11">
                                            <img class="" src="assets/images/circle/circle-2.png"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-12" style="background: #673ab714; padding: 4px 0px; border-radius: 8px;">
                            <div class="col col-md-3" style="text-align: center !important;">
                                <ul class="golist">
                                    <li>
                                        <a href="#" target="_blank" class="img12">
                                            <img class="" src="assets/images/circle/circle-3.png" style="left: 0px !important;"></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col col-md-9">
                                <h5 class="mt-3">Facillities for traders to track the progress of their applications / declarations in real-time.</h5>
                            </div>
                        </div>
                        <div class="col-md-12" style="padding: 4px 0px;">

                            <div class="col col-md-9">
                                <h5 class="mt-3">Data harmonization and standardization among ministries, agencies and customs departments.</h5>
                            </div>
                            <div class="col col-md-3">
                                <ul class="golist">
                                    <li>
                                        <a href="#" target="_blank" class="img13">
                                            <img class="" src="assets/images/circle/circle-4.png"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col col-md-6">
                    <div class="section-title-s2" style="margin: 0px; display: flex; justify-content: center;">
                        ...
                        <h2
                            style="color: #131e4a !important; font-family: 'Montserrat', sans-serif; font-weight: 500; text-align: center; margin-top: 34px; margin-left: 12px; font-size: 32px;">Deemed Approval</h2>
                    </div>
    ...
    <section class="testimonials-section1" style="padding: 0px 0px;">
        <div class="section-title-s2" style="margin: 0px; display: flex; justify-content: center;">
            ...
            <h2 style="color: #131e4a !important; font-family: 'Montserrat', sans-serif; font-weight: 540; text-align: left; margin-top: 34px; margin-left: 12px; font-size: 22px; padding: 10px; border-radius: 29px; margin-bottom: -7px; z-index: 99; position: absolute; left: 2px;">The Meghalaya State Industrial Policy is rooted in certain<br />
                core values, as follows:</h2>
        </div>
            ...
            <div class="row">
                <div class="col col-lg-6 col-md-6">
                    <div class="cta-text">
                        ...
                        <p>
                            Should You Have Any Questions, Or Wish To Speak To Our Qualified Financial Advisors At
                                Meghalaya, Please Contact Us..
                        </p>
                    </div>
                </div>
