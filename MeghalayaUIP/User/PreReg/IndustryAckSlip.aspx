                            ...
                            <div class="col-sm-12 m-b-20">
                                <ul class="list-unstyled mb-0 list-item">
                                    ...
                                    <li>Dear : <label runat="server" id="lblApplicant"></label>,<br />
                                        Your Request for Registration under MIIPP 2024 has been successfully submitted to Meghalaya Investment Promotion Agency (MIPA), Government of Meghalaya.</li>
                                </ul>
                                <div class="col-sm-12 m-b-20 text-center" style="display: flex; justify-content: center;">
                                    <div class="invoice-details text-center d-flex" style="text-align: center;">
                                ...
                                <div class="fotter">
                                    <p>
                                        ...
                                        <br />
                                        Regards</p>
                                    <p><b>Meghalaya Investment Promotion Agency (MIPA)</b></p>
                                    <p><b>Government of Meghalaya</b></p>
                                    <p>Email : meghalayainvestmentpromotionagency@gmail.com</p>
                                </div>
                            </div>
                        </div>
