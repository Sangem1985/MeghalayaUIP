...
{
    public partial class RenewalPaymentReceipt : System.Web.UI.Page
    {
        MasterBAL mstrBAL = new MasterBAL();
        RenewalBAL objcfebal = new RenewalBAL();
        ...
        public void BindData()
        {
            try
            {
                ...
                {
                    txtuid.Text = Convert.ToString(ds.Tables[0].Rows[0]["RENPD_UIDNO"]);
                    ...
                    txtrcptdt.Text = Convert.ToString(ds.Tables[0].Rows[0]["RENPD_TRANSACTIONDATE"]);
