                    ...
                    <asp:GridView ID="gvPreRegUserDashboard" runat="server" AutoGenerateColumns="False" BorderColor="#003399" ShowHeaderWhenEmpty="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Queries Count" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-ForeColor="WindowText">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkQueryCount" runat="server" Text='<%#Eval("QUERYCOUNT")%>' PostBackUrl='<%#Eval("INVESTERID","QueryResponse.aspx?Appid={0}")%>'></asp:LinkButton>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Actions" ItemStyle-Width="12%">
                                ...
                                <ItemTemplate>
                                    <asp:Button ID="ciw_id" runat="server" Text='View' CommandName="VIEW" CssClass="btn btn-info"
