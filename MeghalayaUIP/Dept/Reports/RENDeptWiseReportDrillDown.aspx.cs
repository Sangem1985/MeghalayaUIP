    ...
    public partial class RENDeptWiseReportDrillDown : System.Web.UI.Page
    {
        ...
        protected void ExportToExcel()
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Renewal Department Wise Report" + DateTime.Now.ToString("M/d/yyyy") + ".xls");
                Response.Charset = "";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    ...
                    GVRENDepartment.Style["width"] = "680px";
                    GVRENDepartment.CssClass = "gridTable";

                    HtmlTextWriter hw = new HtmlTextWriter(sw);
                    GVRENDepartment.RenderControl(hw);
            ...
            try
            {
                using (MemoryStream memoryStream = new MemoryStream())
                {
                    using (StringWriter sw = new StringWriter())
                    {
                        ...
                        {
                            // To Export all pages
                            GVRENDepartment.AllowPaging = false;
                            this.BindDepartmentReport();
                            GVRENDepartment.HeaderStyle.ForeColor = System.Drawing.Color.White;
                            //GVDistrictWise.HeaderStyle.BackColor = System.Drawing.Color.Blue;
                            GVRENDepartment.RowStyle.BorderColor = System.Drawing.Color.Black;
                            GVRENDepartment.RowStyle.BorderStyle = BorderStyle.Solid;
                            GVRENDepartment.RowStyle.BorderWidth = Unit.Pixel(1);
                            GVRENDepartment.FooterStyle.ForeColor = System.Drawing.Color.White;
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=Renewal Department Wise Report " + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
