...
{
    public partial class SRVCLabourInterState4 : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            try
            {
                ...
                ds = objSrvcbal.GetSRVCLabourMigrantAct1979DETAILS(Convert.ToString(Session["SRVCQID"]), hdnUserID.Value);

                if (ds != null && ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        txtPrincipalName.Text = Convert.ToString(ds.Tables[0].Rows[0][""]);
                        txtfather.Text = Convert.ToString(ds.Tables[0].Rows[0][""]);
                        txtEmail1.Text = Convert.ToString(ds.Tables[0].Rows[0][""]);
                        txtmobile.Text = Convert.ToString(ds.Tables[0].Rows[0][""]);
                    ...
                    {
                        GVParticulars.DataSource = ds.Tables[3];
                        GVParticulars.DataBind();
                        GVParticulars.Visible = true;
                        ViewState["ParticularsDetails"] = ds.Tables[3];
                    }
                }
            }
            catch (Exception ex)
        ...
        protected void GVDirector_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                SRVCLABOURAMIGRANT1979DETAILS objLabour = new SRVCLABOURAMIGRANT1979DETAILS();
                {
                    objLabour.Questionnariid = "101"; //Convert.ToString(Session["SRVCQID"]);
                    objLabour.DirectorsName = name;
                };
                string result = objSrvcbal.DeleteDirectorMigrant(objLabour);
        ...
        protected void GVManager_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                string result = objSrvcbal.DeleteManagerMigrant(objLabour);
        ...
        protected void btnParticulars_Click(object sender, EventArgs e)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(txtNameContractor.Text) || string.IsNullOrWhiteSpace(txtNameofLocation.Text) || string.IsNullOrWhiteSpace(ddlMaximumNo.SelectedValue) ||
                    string.IsNullOrWhiteSpace(txtContactWork.Text) || string.IsNullOrWhiteSpace(txtEstimated.Text) || string.IsNullOrWhiteSpace(txtDateWork.Text) ||
                    string.IsNullOrWhiteSpace(txtEmployeeLabour.Text))
                {
                    lblmsg0.Text = "Please enter all required details.";
                    Failure.Visible = true;
                    return;
                ...
                DataRow dr = dt.NewRow();
                dr[""] = txtNameContractor.Text.Trim();
                dr[""] = txtNameofLocation.Text.Trim();
                dr[""] = ddlMaximumNo.SelectedValue;
                dr[""] = txtContactWork.Text.Trim();
                dr[""] = txtEstimated.Text.Trim();
                dr[""] = txtDateWork.Text.Trim();
                dr[""] = txtEmployeeLabour.Text.Trim();
                dt.Rows.Add(dr);
        ...
        protected void GVParticulars_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                {
                    objLabour.Questionnariid = "101"; //Convert.ToString(Session["SRVCQID"]);
                    objLabour.NameContractor = name;
                };
                string result = objSrvcbal.DeleteParticulars(objLabour);
        ...
        protected void Btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ErrorMsg == "")
                {
                    ...
                    result = objSrvcbal.InsertLabourDirectorMigrantDetails(objLabour);
                    ...
                    result = objSrvcbal.InsertLabourManagerMigrantDetails(objLabour);




                    DataTable dt2 = ParticularsDetails;
...

                    {
                        ...
                        objLabour.Createdby = "1001"; //hdnUserID.Value;
                        objLabour.IPAddress = getclientIP();
                        objLabour.XMLData = GetParticularsXML();
                    };
                    result = objSrvcbal.InsertLabourParticularsDetails(objLabour);
                    ...
                    objLabour.Createdby = "1001"; //hdnUserID.Value;
                    objLabour.IPAddress = getclientIP();
                    objLabour.PrincipalEMPNAME = txtPrincipalName.Text;
                    objLabour.PrincipalFather = txtfather.Text;
                    objLabour.PrincipalEMAILID = txtEmail1.Text;
                    objLabour.PrincipalMOBILENO = txtmobile.Text;
                    ...
                    result = objSrvcbal.InsertSRVCLabourMigrant1979Details(objLabour);

                    if (result != "")
                    {
                        success.Visible = true;
                        lblmsg.Text = " Labour Migrant State Details Submitted Successfully";
        ...
        public string stepValidations()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(txtPrincipalName.Text) || txtPrincipalName.Text.Trim() == "")
                {
                    errormsg += slno + ". Please enter Principal Employer's Name...! \\n";
                    slno++;
                }
                if (string.IsNullOrEmpty(txtfather.Text) || txtfather.Text.Trim() == "")
                {
                    errormsg += slno + ". Please enter Principal Father...! \\n";
                    slno++;
                }
                if (string.IsNullOrEmpty(txtEmail1.Text) || txtEmail1.Text.Trim() == "")
                {
                    errormsg += slno + ". Please enter Principal Employer's E-Mail Id...! \\n";
                    slno++;
                }
                if (string.IsNullOrEmpty(txtmobile.Text) || txtmobile.Text.Trim() == "")
                {
                    errormsg += slno + ". Please enter Principal Mobile No...! \\n";
                    slno++;
                }
