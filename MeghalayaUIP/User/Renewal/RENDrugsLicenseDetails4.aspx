<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="RENDrugsLicenseDetails4.aspx.cs" Inherits="MeghalayaUIP.User.Renewal.RENDrugsLicenseDetails4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style>
        div#drug, div#drug1, div#drug2, div#drug3, div#drugothers, div#drugcommom {
            width: 100%;
                                    ...
                                    <div class="row">
                                        <div class="drug" id="drug">
                                            ...
                                            <div class="col-md-12 d-flex">
                                                ...
                                                <div class="col-md-4" id="divExpireDate" runat="server" visible="false">
                                                    <div class="form-group row">
                                            ...
                                            <div class="col-md-12 d-flex">
                                                <div class="col-md-4" id="divCancelLic" runat="server" visible="false">
                                                    <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-6 d-flex">
                                                            <asp:TextBox ID="txttradeLic" runat="server" class="form-control" TextMode="MultiLine" onkeypress="return validateNameAndNumbers(event)"></asp:TextBox>
                                        ...
                                        <div class="drug" id="drug2">
                                            ...
                                            <div class="col-md-12 d-flex justify-content-center">
                                                <asp:Button ID="btnStaff" runat="server" Text="Add More" OnClick="btnStaff_Click" CssClass="btn btn-green btn-rounded mt-2 mb-4" Width="110px" />
                                            ...
                                            <div class="col-12 d-flex justify-content-center">
                                                <asp:GridView ID="GVSTAFF" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                    ...
                                                    <Columns>
                                                        <asp:CommandField HeaderText="Delete" ShowDeleteButton="True" ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" />
                                                        <asp:BoundField HeaderText="Name" DataField="RENDM_NAME" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" />
                                                        <asp:BoundField HeaderText="Qualification" DataField="RENDM_QUALIFICATION" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" />
                                                        <asp:BoundField HeaderText="Experience" DataField="RENDM_EXPERIENCE" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" />
                                        ...
                                        <div class="drug" id="drugothers">
                                            ...
                                            <div class="col-md-12 d-flex">
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label class="col-lg-6 col-form-label">Is the premise and plan ready for inspection? <span style="color: red">*</span></label>
                                                        <div class="col-lg-6">
                                                            <asp:RadioButtonList ID="rblInspection" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rblInspection_SelectedIndexChanged">
                                                                <asp:ListItem Text="Yes" Value="Y" />
                                                                <asp:ListItem Text="No" Value="N" />
                                                            </asp:RadioButtonList>
                                                        </div>
                                                ...
                                                <div class="col-md-4" id="DateInsp" runat="server" visible="false">
                                                    <div class="form-group row">
                                                        <label class="col-lg-6 col-form-label">Date for Inspection <span style="color: red">*</span></label>
                                                        <div class="col-lg-6">
                                        ...
                                        <div class="drug" id="drugcommom">
                                            ...
                                            <div class="col-md-12 d-flex">
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-6 d-flex">
                                                            <asp:TextBox ID="txtSpecify" runat="server" class="form-control" onkeypress="return Names(this)"></asp:TextBox>
                                            ...
                                            <div class="col-12 d-flex justify-content-center">
                                                <asp:GridView ID="GVSpecify" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                    ...
                                                    <Columns>
                                                        <asp:CommandField HeaderText="Delete" ShowDeleteButton="True" ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" />
                                                        <asp:BoundField HeaderText="Name of Drug " DataField="RENDA_ADDITIONALITEM" ItemStyle-Width="330px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" />
