...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="#">Renewals</a></li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="card">
                                    ...
                                    <br />
                                    <br />
                                    <div class="alldetails" id="dashboardBasic">
                                        <div class="row">
                                            <div class="col-xl-12 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="col-md-12">
                                                            <h5>Renewal Application Deatils</h5>
                                                            <hr />
                                                        </div>
                                                        ...
                                                        <p class="card-title1 col-lg-12 mt-4 mb-0"><b>Employment Details :</b></p>
                                                        <%--  <h4 class="card-title1 col-lg-12"></h4>--%>
                                                        ...
                                                        <p class="card-title1 col-lg-12 mt-4 mb-0"><b>Project Financials :</b></p>
                                                        <%-- <h4 class="card-title1 col-lg-12"></h4>--%>
                                                        <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="col-xl-12 col-sm-12 col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <p class="card-title1 col-lg-12 mt-4 mb-0"><b>Address of the Establishment:</b></p>
                                                                    ...
                                                                    <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                        <div id="Div1" runat="server" visible="false" class="col-md-4">
                                                                            <div class="col-md-2">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12 col-sm-12 col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="col-md-12">
                                                                        <h5>Contractor Migrant Work Deatils</h5>
                                                                        <hr />
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                        ...
                                                                        <div id="Birth" runat="server" visible="false" class="col-md-4">
                                                                            <div class="col-md-2">
                                                                                <label>Date </label>
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                    ...
                                                                    <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                        ...
                                                                        <div id="Div4" runat="server" visible="false" class="col-md-8">
                                                                            <div class="col-md-2">
                                                                                <label>Establishment's Details  </label>
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                    ...
                                                                    <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                        <div id="Div5" runat="server" visible="false" class="col-md-4">
                                                                            <div class="col-md-2">
                                                                                <label>Nature of work </label>
                                                                            </div>
                                                                            <div class="col-md-2">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                        ...
                                                                        <div id="Inspection" runat="server" visible="false" class="col-md-4">
                                                                            <div class="col-md-2">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12 col-sm-12 col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="col-md-12">
                                                                        <h5>Factories License Details</h5>
                                                                        <hr />
                                                                    </div>
                                                                    <%--  <h4 class="card-title1 col-lg-12"></h4>--%>
                                                                    ...
                                                                    <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                        ...
                                                                        <div id="Factory" runat="server" visible="false" class="col-md-4">
                                                                            <div class="col-md-2">
                                                                    ...
                                                                    <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                        ...
                                                                        <div id="Proprietor" runat="server" visible="false" class="col-md-4">
                                                                            <div class="col-md-2">
                                                                    ...
                                                                    <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                        <div id="Administrative" runat="server" visible="false" class="col-md-4">
                                                                            <div class="col-md-2">
                                                                        ...
                                                                        <div id="Managing" runat="server" visible="false" class="col-md-4">
                                                                            <div class="col-md-2">
                                                                    ...
                                                                    <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                        ...
                                                                        <div id="Approvals" runat="server" visible="false" class="col-md-8">
                                                                            <div class="col-md-2">
                                                                    ...
                                                                    <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                        <div id="ApprovalArrange" runat="server" visible="false" class="col-md-8">
                                                                            <div class="col-md-2">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12 col-sm-12 col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="col-md-12">
                                                                        <h5>Safety and Security Details</h5>
                                                                        <hr />
                                                                    </div>
                                    ...
                                    <section id="dashboardAttachmnt">
                                        <div class="container-fluid">
                                            <div class="row clearfix">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="grdRenattachment" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                        BorderStyle="Solid" BorderWidth="1px" CellPadding="4" ForeColor="#333333"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="File Name" DataField="RENA_FILEDESCRIPTION" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />

                                                            <asp:TemplateField HeaderText="View">
                                                                <ItemTemplate>
                                                                    <asp:HyperLink runat="server" ID="hplApplied" Target="_blank" Text='<%#Eval("RENA_FILENAME")%>' NavigateUrl='<%#Eval("FILENAME")%>' />
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                        </Columns>
                                                ...
                                                <div class="col-sm-12">
                                                    <asp:GridView ID="grdQueries" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="Renewal ID" DataField="RENQDID" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                                ...
                                                <div class="col-md-12">
                                                    <asp:GridView ID="grdQryAttachments" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="FileName" DataField="RENA_FILENAME" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                                            <asp:TemplateField HeaderText="View">
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="linkViewQueryAttachment" Text='<%#Eval("RENA_FILENAME") %>' runat="server"></asp:HyperLink>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="table-responsive">
                                                        <asp:GridView ID="grdApplStatus" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                            ...
                                                            <AlternatingRowStyle BackColor="LightGray" />
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="SI.No" ItemStyle-Width="3px">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                    <ItemTemplate>
                                                                        <%# Container.DataItemIndex + 1%>
                                                                ...
                                                                <asp:BoundField HeaderText="Department ID" DataField="Dept_Id" ItemStyle-Width="10px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Visible="false" />
                                                                <asp:BoundField HeaderText="Renewal ID" DataField="RENDA_RENQDID" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px">
                                                                    <ItemStyle Width="1px" />
                                                                    <HeaderStyle Width="1px" />
                                                                </asp:BoundField>
                                                                <asp:BoundField HeaderText="Approval Name" DataField="ApprovalName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="250px">
                                                                    <ItemStyle Width="6px" />
                                    ...
                                    <div class="table-responsive">
                                        <table align="Center" style="width: 100%; border-color: brown; align-content: center;" class="table table-bordered mb-10">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px">
                                                    <asp:DropDownList ID="ddlapproval" runat="server" Class="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlapproval_SelectedIndexChanged">
                                                        <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
