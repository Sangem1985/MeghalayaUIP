            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul>
                        ...
                        <li><i class="fi fi-br-arrow-up-right-from-square"></i><a href="#" onclick="window.open('PdfFile.ashx?filePath=<%=AppointmentShriRChitturiIASCEO%>', '_blank'); return false;">Appointment of Shri R. Chitturi, IAS Joint Secretary to the Govt. of Meghalaya as the Joint Chief Executive Officer, Invest Meghalaya Authority</a></li>
                        <li><i class="fi fi-br-arrow-up-right-from-square"></i><a href="#" onclick="window.open('PdfFile.ashx?filePath=<%=AppointmentDrVijayKumarCEO%>', '_blank'); return false;">Appointment of Dr. Vijay Kumar D, IAS Commissioner & Secretary to the Govt. of Meghalaya as the Chief Executive Officer of Invest Meghalaya Authority</a></li>
