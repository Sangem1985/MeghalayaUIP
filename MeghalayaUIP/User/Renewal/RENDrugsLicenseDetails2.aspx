<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="RENDrugsLicenseDetails2.aspx.cs" Inherits="MeghalayaUIP.User.Renewal.RENDrugsLicenseDetails2" %>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="drug" id="drug">
                                            ...
                                            <div id="divRepack64" runat="server" visible="true">
                                                <div class="col-md-12 d-flex">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 d-flex">
                                                                <asp:TextBox ID="txtDrugLic" runat="server" class="form-control" TextMode="MultiLine" onkeypress="return Names(this)" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <div class="col-lg-12 d-flex">
                                                                ...
                                                                <asp:Button ID="btnDrug" runat="server" Text="Add More" OnClick="btnDrug_Click" CssClass="btn btn-green btn-rounded" Width="110px" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 d-flex justify-content-center ml-3">
                                                    <asp:GridView ID="GVDRUGLIC" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                        BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CssClass="GRD" ForeColor="#333333"
                                                        GridLines="None" Width="100%" EnableModelValidation="True" Visible="false" OnRowDeleting="GVDRUGLIC_RowDeleting">
                                                ...
                                                <div class="col-md-12 d-flex">
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 d-flex">
                                                                <asp:TextBox ID="txtEmpName" runat="server" class="form-control" Type="text" onkeypress="return Names(this)" TabIndex="1" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <asp:TextBox ID="txtEmpQualify" runat="server" class="form-control" Type="text" onkeypress="return Names(this)" TabIndex="1" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <asp:TextBox ID="txtEmpExperince" runat="server" class="form-control" Type="text" onkeypress="return NumberOnly()" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 d-flex justify-content-center">
                                                    <asp:Button ID="btnTechincal" runat="server" Text="Add More" OnClick="btnTechincal_Click" CssClass="btn btn-green btn-rounded mt-2 mb-4" Width="110px" />
                                                </div>
                                                <div class="col-md-6 d-flex justify-content-center">
                                                    <asp:GridView ID="GVTehnical" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                        BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CssClass="GRD" ForeColor="#333333"
                                                        GridLines="None" OnRowDeleting="GVTehnical_RowDeleting"
                                                ...
                                                <div class="col-md-12 d-flex">
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 d-flex">
                                                                <asp:TextBox ID="txtItem" runat="server" class="form-control" TextMode="MultiLine" onkeypress="return Names(this)" onkeyup="handleKeyUp(this)"></asp:TextBox>
                                                ...
                                                <div class="col-md-6 d-flex justify-content-center ml-3">
                                                    <asp:GridView ID="GVAdditional" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                        BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CssClass="GRD" ForeColor="#333333"
                                                        GridLines="None" Width="100%" EnableModelValidation="True" Visible="false" OnRowDeleting="GVAdditional_RowDeleting">
                                                        <RowStyle BackColor="#ffffff" BorderWidth="1px" />
                                                        <Columns>
                                                            <asp:CommandField HeaderText="Delete" ShowDeleteButton="True" ItemStyle-BackColor="Wheat" ItemStyle-ForeColor="WindowText" />
