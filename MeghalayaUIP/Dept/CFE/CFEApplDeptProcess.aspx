                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <asp:Label ID="lblPincodes" runat="server"></asp:Label>
                                                            ...
                                                            <p class="card-title1 col-lg-12 mt-4 mb-0">
                                                ...
                                                <div class="col-xl-12 col-sm-12 col-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-title1 col-lg-12 mt-4 mb-0">
                                                                <b>Full name and address of the Principal Employer(furnish
                                                father's name in the case of individuals) with Phone No :</b>
                                                            </p>
                                                            <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                <div class="col-md-2">
                                                                    <label>Name</label>
                                                            ...
                                                            <div id="divBoiler" runat="server" visible="false">
                                                                <p class="card-title1 col-lg-12 mt-4 mb-0">
                                                                    <b>Boiler Technical Details :</b>
                                                                </p>
                                                                <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="col-md-12 d-flex">
                                                                ...
                                                                <p class="card-title1 col-lg-12 mt-4 mb-0">
                                                                    <b>Quantity of Explosives proposed to be manufactured/possessed 
                                                        for the purpose stated at serial No. 1 above :</b>
                                                                </p>
                                                            ...
                                                            <div class="col-md-12 row mt-1" style="padding: 0px 0px 0px 13px; text-align: left;">
                                                                <div class="col-md-4" style="border: 1px solid #ccc;">
                                                                    <label>
                                                                        Details of site where explosives will be used and distance of site of use from the 
                                                        storage premises (in case of licence for use)
                                                                    </label>
                                                                </div>
                                                                <div class="col-md-2">
                                                ...
                                                <div class="table-responsive">
                                                    <asp:GridView ID="grdcfeattachment" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="File Name" DataField="CFEA_FILEDESCRIPTION" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                                ...
                                                <div class="col-md-12">
                                                    <asp:GridView ID="grdQryAttachments" runat="server" AutoGenerateColumns="False" BorderColor="#003399"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="FileName" DataField="CFEA_FILENAME" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                                            <asp:TemplateField HeaderText="View">
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="linkViewQueryAttachment" Text='<%#Eval("CFEA_FILENAME") %>' runat="server"></asp:HyperLink>
