    ...
    public partial class IRDistWiseReportDrillDown : System.Web.UI.Page
    {
        ...
        protected void ExportToExcel()
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=District Wise Industry Registrations Report " + DateTime.Now.ToString("M/d/yyyy") + ".xls");
                Response.Charset = "";
            ...
            try
            {
                using (MemoryStream memoryStream = new MemoryStream())
                {
                    using (StringWriter sw = new StringWriter())
                    {
                        ...
                        {
                            // To Export all pages
                            GVDistWise.AllowPaging = false;
                            this.BindDistrictWiseReport();
                            GVDistWise.HeaderStyle.ForeColor = System.Drawing.Color.White;
                            //GVDistrictWise.HeaderStyle.BackColor = System.Drawing.Color.Blue;
                            GVDistWise.RowStyle.BorderColor = System.Drawing.Color.Black;
                            GVDistWise.RowStyle.BorderStyle = BorderStyle.Solid;
                            GVDistWise.RowStyle.BorderWidth = Unit.Pixel(1);
                            GVDistWise.FooterStyle.ForeColor = System.Drawing.Color.White;
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=District Wise Industry Registrations Report " + DateTime.Now.ToString("M/d/yyyy") + ".pdf");
