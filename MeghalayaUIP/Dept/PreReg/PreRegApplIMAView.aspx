<%@ Page Title="" Language="C#" MasterPageFile="~/Dept/dept.Master" AutoEventWireup="true" CodeBehind="PreRegApplIMAView.aspx.cs" Inherits="MeghalayaUIP.Dept.PreReg.PreRegApplIMAView" %>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
             <div class="card-header d-flex justify-content-between">
               <h4 class="card-title mt-1"><b>Industry Registration <asp:Label runat="server" ID="lblHdng"></asp:Label></b></h4>
                <div class="col-md-1">
