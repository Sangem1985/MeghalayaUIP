                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4>Comments on Draft Ammendments</h4>
                                                </div>
                                                <div class="card-body">
                                                                        ...
                                                                        <tr runat="server" id="trComments" visible="false">
                                                                            <td>
                                                                                <table cellpadding="4" cellspacing="5" align="center">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding: 5px; margin: 5px; text-align: left;">Mobile Number
                                                                                        </td>
                                                                                        <td style="padding: 5px; margin: 5px; text-align: left;">
                                                                                        ...
                                                                                        <td style="padding: 5px; margin: 5px; text-align: left;">Mail Id
                                                                                        </td>
                                                                                        <td>
