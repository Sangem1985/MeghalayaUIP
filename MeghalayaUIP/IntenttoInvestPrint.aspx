						...
						<div class="card-body">
							...
							<div class="col-md-12 d-flex tablepadding">
								<div class="col-md-6 d-flex">
									...
									<div class="col-md-6"><asp:Label ID="lblNameCompany" runat="server"></asp:Label></div>
								</div>
								<div class="col-md-6 d-flex">
									<div class="col-md-6">PAN:</div>
									<div class="col-md-6"> <asp:Label ID="lblPan" runat="server"></asp:Label></div>
								</div>
							</div>							
						</div>
					</div>
						...
						<div class="card-body">
							...
							<div class="col-md-12 mb-4 d-flex tablepadding">
								...
								<div class="col-md-6 d-flex">
									...
									<div class="col-md-6">  <asp:Label ID="lblCountry" runat="server"></asp:Label></div>
								</div>
							</div>
							<div class="col-md-12 mb-4 d-flex tablepadding">
								<div class="col-md-6 d-flex">
									<div class="col-md-6">Phone No:</div>
									<div class="col-md-6">   <asp:Label ID="lblPhone" runat="server"></asp:Label></div>
								</div>
								<div class="col-md-6 d-flex">
									<div class="col-md-6">Pin/Zip Code:</div>
									<div class="col-md-6">  <asp:Label ID="lblPin" runat="server"></asp:Label></div>
								</div>
							</div>
							<div class="col-md-12 mb-4 d-flex tablepadding">
								<div class="col-md-6 d-flex">
									<div class="col-md-6">Email ID:</div>
									<div class="col-md-6">   <asp:Label ID="lblEmailId" runat="server"></asp:Label></div>
								</div>
								<div class="col-md-6 d-flex">
									<div class="col-md-6">Fax No:</div>
									<div class="col-md-6"><asp:Label ID="lblFax" runat="server"></asp:Label></div>
								</div>
							</div>
							...
							<div class="col-md-12 mb-4 d-flex tablepadding">
								<div class="col-md-6 d-flex">
									...
									<div class="col-md-6"><asp:Label ID="lblWebsit" runat="server"></asp:Label></div>
								</div>
						...
						<div class="card-body">
							...
							<div class="col-md-12 mb-4 d-flex tablepadding">
								<div class="col-md-6 d-flex">
									...
									<div class="col-md-6"><asp:Label ID="lblNames" runat="server"></asp:Label></div>
								</div>
								<div class="col-md-6 d-flex">
									<div class="col-md-6">Designation:</div>
									<div class="col-md-6"><asp:Label ID="lblDesignation" runat="server"></asp:Label></div>
								</div>
							</div>
							<div class="col-md-12 mb-4 d-flex tablepadding">
								<div class="col-md-6 d-flex">
						...
						<div class="card-body">
							...
							<div class="col-md-12 d-flex tablepadding">
								<div class="col-md-6 d-flex">
									...
									<div class="col-md-6">  <asp:Label ID="lblProjectProposal" runat="server"></asp:Label></div>
								</div>
								<div class="col-md-6 d-flex">
									<div class="col-md-6">Have you signed the MoU/Investment Intention in previous events:</div>
									<div class="col-md-6"> <asp:Label ID="lblInvestment" runat="server"></asp:Label></div>
								</div>
							</div>
							...
							<div class="col-md-12 mb-4 d-flex tablepadding">
								<div class="col-md-6 d-flex">
									...
									<div class="col-md-6"> <asp:Label ID="lblPCB" runat="server"></asp:Label></div>
								</div>
								<div class="col-md-6 d-flex">
									<div class="col-md-6">Sectors:</div>
									<div class="col-md-6"><asp:Label ID="lblSectors" runat="server"></asp:Label></div>
								</div>
							</div>

							<div class="col-md-12 mb-4 d-flex tablepadding">
								<div class="col-md-6 d-flex">
									<div class="col-md-6">Proposed Investment
                                        <br />
                                        (Rs. in Crore):</div>
									<div class="col-md-6"><asp:Label ID="lblProposedInvest" runat="server"></asp:Label></div>
								</div>
								<div class="col-md-6 d-flex">
									<div class="col-md-6">Proposed Employment:</div>
									<div class="col-md-6"> <asp:Label ID="lblEmployment" runat="server"></asp:Label></div>
								</div>
							</div>
							...
							<div class="col-md-12 mb-4 d-flex tablepadding">
								<div class="col-md-6 d-flex">
									...
									<div class="col-md-6"> <asp:Label ID="lblProjectLocation" runat="server"></asp:Label></div>
								</div>
								<div class="col-md-6 d-flex">
									<div class="col-md-6">Expected Year of Commencement of Production:</div>
									<div class="col-md-6"> <asp:Label ID="lblExtendYear" runat="server"></asp:Label></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body">
							...
							<div class="col-md-12 d-flex tablepadding">
								<div class="col-md-6 d-flex">
									...
									<div class="col-md-6"> <asp:Label ID="lblExpectation" runat="server"></asp:Label></div>
								</div>								
							</div>						
