                    ...
                    <div id="navbar" class="navbar-collapse collapse navigation-holder">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    <li><a href="Documents/MIIPP%202024.pdf" class="text-black">
                                            MIIPP, 2024</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12 text-center bgview">
                        ...
                        <p>Empowering Investor at every stage of their journey.<br />
                            Set up your business in Meghalaya with ease- now one of the fastest growing business
                            destination in North- East India.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-xs-12 text-center">
                        ...
                        <div class="col-md-5 bgcirle1" type="button" class="btn btn-primary" data-toggle="modal"
                            ...
                            <div class="col-md-8">
                                <h3>UNNATI 2024</h3>
                                <p>Attractive Incentives available.<br />
                    ...
                    <div class="col col-xs-12 text-center">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-md-12">
                                ...
                                <p>Want to Invest? Fill a simple <a href="IntentInvest.aspx" target="_blank"><span class="colorblue">Intent to Invest<br />
                                        Form</span></a> and we will get in touch. Click here.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-md-12">
                                <h3>REGISTER</h3>
                                <p>Register your business to claim Incentives. <br />
                                    Fill a simple <a href="Registration.aspx" target="_blank"><span class="colorblue">Registration Form</span></a>. Click here.</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col col-xs-12 text-center"
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-md-12">
                                <a href="login.aspx" target="_blank"><h3><i class="fi fi-br-form"></i> Apply for Clearance/ approvals for your business</h3></a>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-md-12">
                                <a href="login.aspx" target="_blank"><h3><i class="fi fi-br-track"></i> Track Application Status</h3></a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col col-lg-6 col-md-6 col-sm-12">
                            <div class="widget contact-widget service-link-widget">
                                ...
                                <ul>
                                    <li>Invest Meghalaya Authority,<br /> Secretariat Main Building, M.G Road,<br />
                                        Shillong - 793 001, East Khasi Hills District,<br /> Meghalaya.<br /></li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col col-xs-12">
                            <p class="copyright">© 2024 Copyright Invest Meghalaya Authority. All Rights Reserved |
                                Design and Developed By CMS Computers India Pvt Ltd</p>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="exampleModalLongTitle1">
                    <img src="assets/assetsbeta/images/circle1.png" style="width: 10%;position: absolute;left: 25px;top: 7px;"> Uttar Poorva Transformative Industrialization Scheme (UNNATI), 2024 &nbsp;&nbsp;&nbsp;&nbsp;<span
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered modeltab1">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">01. Capital Investment Incentive<br/> (For Both New & Expanding Units)​</th>
                            <td>
                                <ul>
                        ...
                        <tr>
                            <th scope="row">02. Central Capital Interest Subvention<br/> (For Both New & Expanding Units)</th>
                            <td colspan="2">
                                <ul>
                        ...
                        <tr>
                            <th scope="row">03. Manufacturing Services linked incentive<br/> (MSLI) – Fo& r New Units only</th>
...
<li><i class="fi fi-br-redo"></i> Zone B: 100% of eligible value of investment in P&M</li>
                ...
                <p class="colorpurpule"><br/>Eligibility</p>
                    ...
                    <tbody>
                        <tr>
                            <td><b><i class="fi fi-br-redo"></i> Capital Investment Incentive (For Both New & Expanding Units):</b>
                                <br/><i class="fi fi-br-redo"></i> For manufacturing units, minimum investment of <b>Rs 50 Lakhs for Micro and Rs 1 Crore for others</b>
                                <br/><i class="fi fi-br-redo"></i> For service units, minimum investment of <b>Rs 50 Lakh for Micro & others</b>
                                <br/>Unit will be considered ‘Expansion’ only if the cost of new P&M required is <b>at least 25%</b> of the total investment
                                </td>
                                <td><b><i class="fi fi-br-redo"></i> Capital Investment Incentive (For Both New & Expanding Units):</b>
                                    <br/><i class="fi fi-br-redo"></i> For manufacturing units, minimum investment of <b>Rs 50 Lakhs for Micro and Rs 1 Crore for others</b>
                                    <br/><i class="fi fi-br-redo"></i> For service units, minimum investment of <b>Rs 50 Lakh for Micro & others</b>
                        ...
                        <tr>
                            <td><b><i class="fi fi-br-redo"></i> Manufacturing & Services linked incentive (MSLI)– For New Units only – </b><br/>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="exampleModalLongTitle">
                        <img src="assets/assetsbeta/images/circle2.png"  style="width: 10%;position: absolute;left: 25px;top: 7px;" /> Meghalaya Industrial and Investment
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered modeltab">
                        <thead>
                            <tr>
                                <th scope="col">INCENTIVES</th>
                                <th scope="col" style="background: #9B57CE;">Micro<br />(< INR 1 Cr) </th>
                                <th scope="col" style="background: #9B57CE;">Small<br />(INR 1 – 10 Cr)</th>
                                <th scope="col" style="background: #9B57CE;">Medium <br />(INR 10 – 50 Cr) </th>
                                <th scope="col" style="background: #9B57CE;">Large<br />(> INR 50 Cr) </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                    ...
                    <p class="colorblue"><br/>Additional Incentives</p>
                    <img src="assets/assetsbeta/images/modelimg2.jpg" alt=""/>
                   
                    <p class="colorblue"><br/>Main Eligibility Criteria</p>
