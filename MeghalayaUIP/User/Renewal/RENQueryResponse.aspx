<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="RENQueryResponse.aspx.cs" Inherits="MeghalayaUIP.User.Renewal.RENQueryResponse" %>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Renewal Query Details</h4>
                                                    ...
                                                    <div class="col-md-12 d-flex">
                                                           <div class="col-md-4">
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label">Application ID</label>
                                                                <div class="col-lg-6 d-flex">
                                                                    <spna class="dots">:</spna><asp:Label runat="server" ID="lblApplicationID"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-6" id="Approval" runat="server" visible="false">
                                                            <div class="form-group row">
                                                    ...
                                                    <div class="container">
                                                        <div class="row" id="divDetails" runat="server" visible="false">
                                                            <div class="col-md-12 d-flex justify-content-center">
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-lg-6 col-form-label">Renewal ID:</label>
                                                                        <div class="col-lg-6 d-flex">
                                                                            <asp:Label runat="server" ID="lblRENQid"></asp:Label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
